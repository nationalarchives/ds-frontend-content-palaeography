...
document.write("    		<PARAM NAME='src' VALUE='/pathways/palaeography/swf/ZoomifyDynamicViewerLandscape.swf'>");
document.write("			<PARAM NAME='FlashVars' VALUE='" + paramString + "' >");
document.write("		<EMBED SRC='/pathways/palaeography/swf/ZoomifyDynamicViewerLandscape.swf'");
